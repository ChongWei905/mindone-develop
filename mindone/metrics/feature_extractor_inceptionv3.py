...
class FeatureExtractorInceptionV3(nn.Cell):
    ...
    def __init__(
        ...
        # todo: figure out if the resizing is identical
        self.resize = ops.operations.ResizeBilinear((self.INPUT_IMAGE_SIZE, self.INPUT_IMAGE_SIZE))
    ...
    def construct(self, x: Tensor) -> Tensor:
        ...
        if '64' == self.request_feature:
            return self.adaptive_avg_pool2d(x).squeeze(-1).squeeze(-1)
