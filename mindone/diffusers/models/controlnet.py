...
class ControlNetConditioningEmbedding(nn.Cell):
    ...
    def __init__(
        ...
        self.conv_in = mint.nn.Conv2d(conditioning_channels, block_out_channels[0], kernel_size=3, padding=1)
        ...
        for i in range(len(block_out_channels) - 1):
            ...
            blocks.append(mint.nn.Conv2d(channel_in, channel_in, kernel_size=3, padding=1))
            blocks.append(mint.nn.Conv2d(channel_in, channel_out, kernel_size=3, padding=1, stride=2))
...
class ControlNetModel(ModelMixin, ConfigMixin, FromOriginalModelMixin):
    ...
    def construct(
        ...
        # 1. time
        timesteps = timestep
        # todo: unavailable interface mint.is_tensor
        ...
        if guess_mode and not self.config["global_pool_conditions"]:
            # todo: unavailable interface: mint.logspace
